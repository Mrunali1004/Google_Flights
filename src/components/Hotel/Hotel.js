...
const Hotel = () => {
  ...
  return (
    <>
      <div className="max-w-md mx-auto mt-20 p-10 bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700 rounded-lg shadow-lg h-96">
        <h1 className="text-3xl font-bold text-center mb-6 text-black">
          Find Your Perfect Stay
        </h1>
        <p className="text-center text-lg text-teal-200 italic mb-6">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-2 bg-teal-900 text-white font-semibold rounded-md transform transition duration-300 ease-in-out ${
              loading ? "bg-teal-300 cursor-not-allowed" : "hover:bg-teal-300"
            }`}
          >
